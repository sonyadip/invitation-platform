...
CREATE TABLE IF NOT EXISTS platform_settings (
    ...
    home_templates_eyebrow VARCHAR(255) NULL,
    home_templates_heading VARCHAR(255) NULL,
    home_booking_eyebrow VARCHAR(255) NULL,
    home_booking_heading VARCHAR(255) NULL,
    home_booking_cta VARCHAR(255) NULL,
    home_hero_seal_text VARCHAR(255) NULL,
    home_stat_number VARCHAR(255) NULL,
    home_stat_label VARCHAR(255) NULL,
